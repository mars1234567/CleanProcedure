...
namespace NetFrame.Net.UDP.Sock.Asynchronous
{
    ...
    public class AsyncSocketUDPServer
    {
        ...
        //    : this(IPAddress.Any, listenPort, 100)
        //{
        //}
        ...
        //    : this(localEP.Address, localEP.Port, 100)
        //{
        //}
        ...
        public AsyncSocketUDPServer(IPAddress localIPAddress, int listenPort,int cport, int maxClient)
        {
            ...
            remoteip = new IPEndPoint(IPAddress.Any, cport);
